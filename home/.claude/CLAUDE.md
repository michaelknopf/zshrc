...
- Never run python commands directly within a python project. Always use `uv run ...` or use the project virtualenv.
...
- Use inline comments liberally to explain why something is done a certain way. Don't use them just to annotate the code with an English rephrasing of what is obvious from the code though. But DO leave a healthy trail of comments, explaining the rationale behind decisions.
...
- Deeply nested indentation is a sign of poor abstraction. Find ways to break the code up into smaller functions.
